...
import StripeSuccessPage from "./pages/shopping-view/stripe-success-page";
...
function App() {
  ...
  if(isLoading) return <Skeleton className="flex h-[600px] w-[800px] justify-center items-center bg-black" />
  return (
